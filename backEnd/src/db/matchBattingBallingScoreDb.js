...
const sql_batting2 = "SELECT * FROM BatsmanScoresFirstInnings";

const sql_balling1 = "SELECT * FROM BatsmanScoresFirstInnings";

const sql_balling2 = "SELECT * FROM BatsmanScoresFirstInnings";
